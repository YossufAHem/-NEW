...
client.on("ready", () => {
  ...
  client.user.setGame(`Stars Ticket |${prefix}new`);
});
...
client.on("message", (message) => {
  ...
  if (message.content.toLowerCase().startsWith(prefix + `help`)) {
    ...
    .setColor(0xCF40FA)
    .setDescription(` *Stars Ticket* هذا البوت للمساعدة فقط `)
    .addField(`Tickets`, `[${prefix}new]() > **يفتح تذكرة جديدة ويضع علامات على فريق الدعم**\n[${prefix}c]() > **يغلق تذكرة تم حلها أو تم فتحها عن طريق الصدفة**
`)
